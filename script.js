...
// Agrupa todas as listas em um único array
var allQuotes = [
  obiwanQuotes,
  darthvaderQuotes,
  yodaQuotes,
...
function generateQuote() {
  ...
  var randomGroup = allQuotes[Math.floor(Math.random() * allQuotes.length)];

  // escolhe uma frase desse personagem
  var randomQuote = randomGroup[Math.floor(Math.random() * randomGroup.length)];
